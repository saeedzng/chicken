...
export function useMasterContract() {
  ...
  const wallet_referal_address1 =  Address.parse("EQD-RTO-fnhtd-_sA6BHyAc_1XYjUc9CyJ5u3-oT_4lKnxsl")
  ...
  const masterContract = useAsyncInitialize(async () => {
    ...
    const contract = new Master(
      Address.parse("EQD-RTO-fnhtd-_sA6BHyAc_1XYjUc9CyJ5u3-oT_4lKnxsl") // replace with your master address 
    );
